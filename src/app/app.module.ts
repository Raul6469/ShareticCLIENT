...
import { QcmEditorComponent } from './components/qcm-editor/qcm-editor.component';
...
@NgModule({
  ...
  imports: [
    ...
    RouterModule.forRoot([
      ...
      {path: 'qcmeditor', component: QcmEditorComponent, pathMatch: 'full', canActivate: [AuthGuard]},
